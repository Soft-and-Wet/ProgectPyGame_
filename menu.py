...
class Menu(QMainWindow):
    def __init__(self):
        ...
        self.im_background = QPixmap("images/menu/menu.png")
        ...
        self.s_lvl_volume = [[0, 'images/menu/vol_lvl_0'],
                             [2, 'images/menu/vol_lvl_1'],
                             [4, 'images/menu/vol_lvl_2'],
                             [6, 'images/menu/vol_lvl_3'],
                             [8, 'images/menu/vol_lvl_4'],
                             [10, 'images/menu/vol_lvl_5']]
        self.lvl_volume = 6
    ...
    def initUI(self):
        ...
        self.btn_play.setIcon(QIcon('images/menu/but_play.png'))
        ...
        self.btn_vol_plus.setIcon(QIcon('images/menu/vol_plus.png'))
        ...
        self.btn_vol_minus.setIcon(QIcon('images/menu/vol_minus.png'))
